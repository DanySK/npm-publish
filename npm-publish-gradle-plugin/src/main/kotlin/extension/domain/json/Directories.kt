...
public abstract class Directories : GenericJsonObject() {
  ...
  @get:Input @get:Optional public abstract val lib: Property<String>

  /** [bin](https://docs.npmjs.com/files/package.json#directoriesbin) */
  @get:Input @get:Optional public abstract val bin: Property<String>

  /** [man](https://docs.npmjs.com/files/package.json#directoriesman) */
  @get:Input @get:Optional public abstract val man: Property<String>

  /** [doc](https://docs.npmjs.com/files/package.json#directoriesdoc) */
  @get:Input @get:Optional public abstract val doc: Property<String>

  /** [example](https://docs.npmjs.com/files/package.json#directoriesexample) */
  @get:Input @get:Optional public abstract val example: Property<String>

  /** [test](https://docs.npmjs.com/files/package.json#directoriestest) */
  @get:Input @get:Optional public abstract val test: Property<String>
