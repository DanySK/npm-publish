...
public abstract class PackageJson : GenericJsonObject() {
  ...
  @get:Input @get:Optional public abstract val description: Property<String>

  /** [keywords](https://docs.npmjs.com/files/package.json#keywords) */
  @get:Input @get:Optional public abstract val keywords: SetProperty<String>

  /** [homepage](https://docs.npmjs.com/files/package.json#homepage) */
  @get:Input @get:Optional public abstract val homepage: Property<String>

  /** [license](https://docs.npmjs.com/files/package.json#license) */
  @get:Input @get:Optional public abstract val license: Property<String>
  ...
  @get:Input @get:Optional public abstract val browser: Property<String>

  /** [private](https://docs.npmjs.com/files/package.json#private) */
  @get:Input @get:Optional public abstract val private: Property<Boolean>

  /** [files](https://docs.npmjs.com/files/package.json#files) */
  @get:Input @get:Optional public abstract val files: SetProperty<String>

  /** [os](https://docs.npmjs.com/files/package.json#os) */
  @get:Input @get:Optional public abstract val os: ListProperty<String>

  /** [cpu](https://docs.npmjs.com/files/package.json#cpu) */
  @get:Input @get:Optional public abstract val cpu: ListProperty<String>

  /** [bugs](https://docs.npmjs.com/files/package.json#bugs) */
  @get:Nested @get:Optional public abstract val bugs: Property<Bugs>

  /** [author](https://docs.npmjs.com/files/package.json#people-fields-author-contributors) */
  @get:Nested @get:Optional public abstract val author: Property<Person>

  /** [contributors](https://docs.npmjs.com/files/package.json#people-fields-author-contributors) */
  @get:Nested @get:Optional public abstract val contributors: SetProperty<Person>

  /** [bin](https://docs.npmjs.com/files/package.json#bin) */
  @get:Nested @get:Optional public abstract val bin: Property<JsonObject<String>>

  /** [man](https://docs.npmjs.com/files/package.json#man) */
  @get:Nested @get:Optional public abstract val man: Property<JsonObject<String>>

  /** [directories](https://docs.npmjs.com/files/package.json#directories) */
  @get:Nested @get:Optional public abstract val directories: Property<Directories>

  /** [repository](https://docs.npmjs.com/files/package.json#repository) */
  @get:Nested @get:Optional public abstract val repository: Property<Repository>

  /** [scripts](https://docs.npmjs.com/files/package.json#scripts) */
  @get:Nested @get:Optional public abstract val scripts: Property<JsonObject<String>>

  /** [config](https://docs.npmjs.com/files/package.json#config) */
  @get:Nested @get:Optional public abstract val config: Property<GenericJsonObject>

  /** [engines](https://docs.npmjs.com/files/package.json#engines) */
  @get:Nested @get:Optional public abstract val engines: Property<JsonObject<String>>

  /** [publishConfig](https://docs.npmjs.com/files/package.json#publishconfig) */
  @get:Nested @get:Optional public abstract val publishConfig: Property<PublishConfig>

  /** [dependencies](https://docs.npmjs.com/files/package.json#dependencies) */
  @get:Nested @get:Optional public abstract val dependencies: Property<Dependencies>

  /** [devDependencies](https://docs.npmjs.com/files/package.json#devdependencies) */
  @get:Nested @get:Optional public abstract val devDependencies: Property<Dependencies>

  /** [peerDependencies](https://docs.npmjs.com/files/package.json#peerdependencies) */
  @get:Nested @get:Optional public abstract val peerDependencies: Property<Dependencies>

  /** [optionalDependencies](https://docs.npmjs.com/files/package.json#optionaldependencies) */
  @get:Nested @get:Optional public abstract val optionalDependencies: Property<Dependencies>

  /**
   * [bundledDependencies](https://docs.npmjs.com/files/package.json#bundleddependencies) Top
   * priority if set, disregards all the other configurations
   */
  @get:Input @get:Optional public abstract val bundledDependencies: SetProperty<String>
