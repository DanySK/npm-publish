...
public abstract class NpmRegistry : NamedInput {
   ...
   */
  @get:Input public abstract val access: Property<NpmAccess>

  /** NPM registry uri to publish packages to. Should include schema domain and path if required */
  @get:Input public abstract val uri: Property<URI>

  /** Optional OTP to use when authenticating with the registry */
  @get:Input @get:Optional public abstract val otp: Property<String>

  /**
   * Auth token to use when authenticating with the registry. Either [authToken], [auth] or
   * [username] + [password] should be provided.
   * [More info](https://docs.npmjs.com/about-access-tokens)
   */
  @get:Input @get:Optional public abstract val authToken: Property<String>

  /**
   * Base64 authentication string when authenticating with the registry. Either [authToken], [auth]
   * or [username] + [password] should be provided.
   */
  @get:Input @get:Optional public abstract val auth: Property<String>

  /**
   * Username to use when authenticating with the registry. Should always be specified together with
   * a [password]. Either [authToken], [auth] or [username] + [password] should be provided.
   */
  @get:Input @get:Optional public abstract val username: Property<String>

  /**
   * Password to use when authenticating with the registry. Should always be specified together with
   * a [username]. Either [authToken], [auth] or [username] + [password] should be provided.
   */
  @get:Input @get:Optional public abstract val password: Property<String>
   ...
   */
  @get:Input @get:Optional public abstract val dry: Property<Boolean>
