 ...
 * 3. Gradle's properties (`-Pprop=value`, `ORG_GRADLE_PROJECT_prop=value` env variable,
 *    `-Dorg.gradle.project.prop=value` system property or `prop=value` stored in
 *    `gradle.properties` file)
 * 4. Env variables (`PROP=value`)
 * 5. [default] value provider
 *
 * Additionally, prop names replace spaces with dots. Env variable names are uppercase prop names
